...
module Danbooru
  class Configuration
    ...
    # * `%DELETION_ID%`: The id of the post deletion (used for the appeal link)
...
If you would like to contest the deletion, click \"this link\":[/appeals/new?disp_id=%DELETION_ID%&qtype=post_deletion].
