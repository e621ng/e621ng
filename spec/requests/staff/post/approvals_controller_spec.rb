...
RSpec.describe Staff::Post::ApprovalsController do
  ...
  # ---------------------------------------------------------------------------
  # POST /staff/post/approval
  # ---------------------------------------------------------------------------

  describe "POST /staff/post/approval" do
    it "redirects anonymous to the login page" do
      post staff_post_approval_path, params: { post_id: pending_post.id }
    ...
    context "as an approver" do
      ...
      it "returns 201 for an approvable post" do
        post staff_post_approval_path(format: :json), params: { post_id: pending_post.id }
      ...
      #   post staff_post_approval_path(format: :json), params: { post_id: approved_post.id }
      ...
      #   post staff_post_approval_path(format: :json), params: { post_id: locked_post.id }
  ...
  # ---------------------------------------------------------------------------
  # DELETE /staff/post/approval
  # ---------------------------------------------------------------------------

  describe "DELETE /staff/post/approval" do
    it "redirects anonymous to the login page" do
      delete staff_post_approval_path, params: { post_id: approved_post.id }
      expect(response).to redirect_to(new_session_path)
    end
    ...
    context "as the approver of the post" do
      ...
      it "returns 204 No Content" do
        delete staff_post_approval_path(format: :json), params: { post_id: approved_post.id }
      ...
      #   delete staff_post_approval_path(format: :json), params: { post_id: pending_post.id }
