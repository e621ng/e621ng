...
RSpec.describe Staff::FilesController do
  ...
  # ---------------------------------------------------------------------------
  # POST /staff/files - create
  # ---------------------------------------------------------------------------

  describe "POST /staff/files" do
  ...
  # ---------------------------------------------------------------------------
  # PATCH /staff/files/:id - update
  # ---------------------------------------------------------------------------

  describe "PATCH /staff/files/:id" do
  ...
  # ---------------------------------------------------------------------------
  # DELETE /staff/files/:id - destroy
  # ---------------------------------------------------------------------------

  describe "DELETE /staff/files/:id" do
