...
RSpec.describe Staff::SecurityController do
  ...
  describe "GET /staff/security" do
    it "redirects anonymous to the login page" do
      get staff_security_index_path
      expect(response).to redirect_to(new_session_path(url: staff_security_index_path))
    end
  ...
  # ---------------------------------------------------------------------------
  # PUT /staff/security/panic
  # ---------------------------------------------------------------------------

  describe "PUT /staff/security/panic" do
    it "redirects anonymous to the login page" do
    ...
    context "as admin" do
      ...
      it "redirects to the security dashboard" do
        put panic_staff_security_index_path
        expect(response).to redirect_to(staff_security_index_path)
      end
      ...
      it "logs a lockdown_panic StaffAuditLog entry" do
        expect { put panic_staff_security_index_path }.to change(StaffAuditLog, :count).by(1)
  ...
  # ---------------------------------------------------------------------------
  # PUT /staff/security/enact
  # ---------------------------------------------------------------------------

  describe "PUT /staff/security/enact" do
    it "redirects anonymous to the login page" do
      put enact_staff_security_index_path
      expect(response).to redirect_to(new_session_path)
    end
    ...
    context "as admin" do
      ...
      it "enables uploads lockdown when the uploads param is '1'" do
        put enact_staff_security_index_path, params: { lockdown: { uploads: "1" } }
        expect(Security::Lockdown.uploads_disabled?).to be true
      end
  ...
  # ---------------------------------------------------------------------------
  # PUT /staff/security/uploads_min_level
  # ---------------------------------------------------------------------------

  describe "PUT /staff/security/uploads_min_level" do
    it "redirects anonymous to the login page" do
      put uploads_min_level_staff_security_index_path,
  ...
  # ---------------------------------------------------------------------------
  # PUT /staff/security/uploads_hide_pending
  # ---------------------------------------------------------------------------

  describe "PUT /staff/security/uploads_hide_pending" do
    it "redirects anonymous to the login page" do
      put uploads_hide_pending_staff_security_index_path,
  ...
  # ---------------------------------------------------------------------------
  # PUT /staff/security/maintenance
  # ---------------------------------------------------------------------------

  describe "PUT /staff/security/maintenance" do
    it "redirects anonymous to the login page" do
      put maintenance_staff_security_index_path
      expect(response).to redirect_to(new_session_path)
    end
