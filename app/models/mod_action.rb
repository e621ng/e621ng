...
class ModAction < ApplicationRecord
  ...
  KnownActions = {
    ...
    comment_undelete: { comment_id: :integer, user_id: :integer },
    comment_destroy: { comment_id: :integer, user_id: :integer },
    ...
    forum_post_undelete: { forum_post_id: :integer, forum_topic_id: :integer, user_id: :integer },
    forum_post_destroy: { forum_post_id: :integer, forum_topic_id: :integer, user_id: :integer },
    ...
    forum_topic_undelete: { forum_topic_id: :integer, forum_topic_title: :string, user_id: :integer },
    forum_topic_destroy: { forum_topic_id: :integer, forum_topic_title: :string, user_id: :integer },
    ...
    post_version_delete: { version: :integer, post_id: :integer },
    post_version_undelete: { version: :integer, post_id: :integer },
  }.freeze

  ProtectedActionKeys = %w[staff_note_create staff_note_update staff_note_delete staff_note_undelete ip_ban_create ip_ban_delete post_version_delete post_version_undelete].freeze
