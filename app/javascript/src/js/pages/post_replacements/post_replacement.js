...
PostReplacement.approve = function (id, penalize_current_uploader) {
  ...
  $.ajax({
    ...
    .done((html) => {
      E621.Flash.success("Replacement approved.");
...
PostReplacement.reject = function (id) {
  ...
  $.ajax({
    ...
    .done((html) => {
      E621.Flash.success("Replacement rejected.");
      $row.replaceWith(html);
    })
    .fail((data) => {
...
PostReplacement.promote = function (id) {
  ...
  $.ajax({
    ...
    .done((html) => {
      E621.Flash.success("Replacement promoted to a new post.");
      $row.replaceWith(html);
    })
    .fail((data) => {
...
PostReplacement.toggle_penalize = function ($target) {
  ...
  $.ajax({
    ...
    .done((html) => {
      E621.Flash.success("Penalization toggled.");
...
PostReplacement.destroy = function (id) {
  ...
  $.ajax({
    ...
    .done(() => {
      E621.Flash.success("Replacement destroyed.");
      $row.remove();
    })
    .fail((data) => {
