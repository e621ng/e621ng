export default class SVGIcon {
  ...
  static ICONS: { [key: string]: string } = {
    ...
    "sidebar_hide": '<rect x="2" y="3" width="20" height="18" rx="2"/><path d="M11 3v18"/><path d="m8 9-3 3 3 3"/>',
    "sidebar_show": '<rect x="2" y="3" width="20" height="18" rx="2"/><path d="M11 3v18"/><path d="m5 9 3 3-3 3"/>',
  ...
  static render (name: string, strokeWidth = 2): SVGElement | null {
