...
class TagQuery
  ...
  #
  # IDEA: Put metatags at end of results instead of beginning (faster if exceeds `tag_query_limit`)
  ...
  # TODO: Benchmark `value&.casecmp("true") == 0`, `value&.downcase == "true"`, & `value&.casecmp("true").zero`
