...
class ModActionDecorator < ApplicationDecorator
  ...
  def format_description
    ...
    when "forum_post_undelete"
      "Undeleted forum ##{vals['forum_post_id']} in topic ##{vals['forum_topic_id']} by #{user}"
    when "forum_post_destroy"
      "Destroyed forum ##{vals['forum_post_id']} in topic ##{vals['forum_topic_id']} by #{user}"
    ...
    when "forum_topic_undelete"
      "Undeleted topic ##{vals['forum_topic_id']} (with title #{vals['forum_topic_title']}) by #{user}"
    when "forum_topic_destroy"
      "Destroyed topic ##{vals['forum_topic_id']} (with title #{vals['forum_topic_title']}) by #{user}"
