    ...
    base.document_store.index = {
      ...
      mappings: {
        ...
        properties: {
          ...
          tag_count_form: { type: "integer" },
          tag_count_studio: { type: "integer" },
          tag_count_category: { type: "integer" },
          tag_count_genre: { type: "integer" },
          tag_count_creature: { type: "integer" },
          tag_count_entity: { type: "integer" },
          tag_count_demographics: { type: "integer" },
          tag_count_attire: { type: "integer" },
          tag_count_garment: { type: "integer" },
          tag_count_adornment: { type: "integer" },
          tag_count_role: { type: "integer" },
          tag_count_hair: { type: "integer" },
          tag_count_body: { type: "integer" },
          tag_count_expression: { type: "integer" },
          tag_count_position: { type: "integer" },
          tag_count_view: { type: "integer" },
          tag_count_action: { type: "integer" },
          tag_count_explicit: { type: "integer" },
          tag_count_setting: { type: "integer" },
          tag_count_flora: { type: "integer" },
          tag_count_object: { type: "integer" },
          tag_count_substance: { type: "integer" },
          tag_count_lore: { type: "integer" },
          tag_count_unique: { type: "integer" },
          tag_count_other: { type: "integer" },
          tag_count_request: { type: "integer" },
          tag_count_medium: { type: "integer" },
          tag_count_meta: { type: "integer" },
          tag_count_invalid: { type: "integer" },
          tag_count_group: { type: "integer" },
  ...
  def as_indexed_json(options = {})
    {
      ...
      tag_count_form:      tag_count_form,
      tag_count_studio:     tag_count_studio,
      tag_count_category:  tag_count_category,
      tag_count_genre:     tag_count_genre,
      tag_count_creature: tag_count_creature,
      tag_count_entity:   tag_count_entity,
      tag_count_demographics: tag_count_demographics,
      tag_count_attire:      tag_count_attire,
      tag_count_garment:     tag_count_garment,
      tag_count_adornment:   tag_count_adornment,
      tag_count_role:        tag_count_role,
      tag_count_hair:        tag_count_hair,
      tag_count_body:        tag_count_body,
      tag_count_expression:  tag_count_expression,
      tag_count_position:    tag_count_position,
      tag_count_view:        tag_count_view,
      tag_count_action:      tag_count_action,
      tag_count_explicit:    tag_count_explicit,
      tag_count_setting:     tag_count_setting,
      tag_count_flora:       tag_count_flora,
      tag_count_object:      tag_count_object,
      tag_count_substance:   tag_count_substance,
      tag_count_unique:     tag_count_unique,
      tag_count_other:     tag_count_other,
      tag_count_request:   tag_count_request,
      tag_count_medium:    tag_count_medium,
      tag_count_group:    tag_count_group,
