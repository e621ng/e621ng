...
class TagAliasesController < ApplicationController
  ...
  def index
    @tag_aliases = TagAlias.includes(:antecedent_tag, :consequent_tag, :creator, :creator, :approver, forum_post: :votes).search(search_params).paginate(params[:page], :limit => params[:limit])
