class PostsController < ApplicationController
  ...
  def post_params
    ...
    permitted_params += %i[is_status_locked] if CurrentUser.is_moderator?
    permitted_params += %i[is_comment_disabled locked_tags hide_from_anonymous hide_from_search_engines] if CurrentUser.is_admin?
