...
class PostsController < ApplicationController
  ...
  def index
    if params[:md5].present?
      ...
      @post_set = PostSets::Post.new(tag_query, params[:page], params[:limit], random: params[:random], use_new_syntax: (CurrentUser.use_new_search_syntax? || params[:use_new_syntax]))
