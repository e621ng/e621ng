  ...
  class AutomodDmailsController < ApplicationController
    ...
    def mark_as_read
      ...
      respond_to do |format|
        format.html { redirect_to(staff_automod_dmail_path(@dmail), notice: "Message marked as read") }
        format.json
      end
    end
    ...
    def mark_as_unread
      ...
      respond_to do |format|
        format.html { redirect_to(staff_automod_dmail_path(@dmail), notice: "Message marked as unread") }
        format.json
      end
    end
