  ...
  class AutomodRulesController < ApplicationController
    ...
    def create
      ...
      if @automod_rule.save
        redirect_to staff_automod_rules_path, notice: "Automod rule created"
      else
        render :new
      end
    end
    ...
    def update
      if @automod_rule.update(automod_rule_params)
        redirect_to staff_automod_rules_path, notice: "Automod rule updated"
      else
        render :edit
      end
    end
    ...
    def destroy
      ...
      redirect_to staff_automod_rules_path, notice: "Automod rule deleted"
    end
