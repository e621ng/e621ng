  ...
  ORDER_MAP = Hash.new([{ id: :desc }]).merge(
    {
      ...
      "deleted" => [[{ deleted: :desc }, { deleted_at: { order: :desc, missing: :_last } }, { id: :desc }], [{ deleted: :desc }, { deleted_at: { order: :asc, missing: :_last } }, { id: :asc }]],
      "deleted_desc" => [[{ deleted: :desc }, { deleted_at: { order: :desc, missing: :_last } }, { id: :desc }], [{ deleted: :desc }, { deleted_at: { order: :asc, missing: :_last } }, { id: :asc }]],
      "deleted_asc" => [[{ deleted: :desc }, { deleted_at: { order: :asc, missing: :_last } }, { id: :asc }], [{ deleted: :desc }, { deleted_at: { order: :desc, missing: :_last } }, { id: :desc }]],
      "flagged" => [[{ flagged: :desc }, { flagged_at: { order: :desc, missing: :_last } }, { id: :desc }], [{ flagged: :desc }, { flagged_at: { order: :asc, missing: :_last } }, { id: :asc }]],
      "flagged_desc" => [[{ flagged: :desc }, { flagged_at: { order: :desc, missing: :_last } }, { id: :desc }], [{ flagged: :desc }, { flagged_at: { order: :asc, missing: :_last } }, { id: :asc }]],
      "flagged_asc" => [[{ flagged: :desc }, { flagged_at: { order: :asc, missing: :_last } }, { id: :asc }], [{ flagged: :desc }, { flagged_at: { order: :desc, missing: :_last } }, { id: :desc }]],
