...
**IMPORTANT**: If you are using an online devcontainer instance (such as GitHub Codespaces), it is **HIGHLY RECOMMENDED** to modify `db/populate.rb` to use e926 or specify 'rating:s' in the post population. Other modifications may also be nesessary to comply with their content policies.
